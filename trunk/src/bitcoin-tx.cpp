...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " canuckcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  canuckcoin-tx [options] <hex-tx> [commands]  Update hex-encoded canuckcoin transaction\n" +
            "or:     canuckcoin-tx [options] -create [commands]   Create hex-encoded canuckcoin transaction\n" +
            "\n";
