...
"""Verify that starting canuckcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start canuckcoin with -h for help text")
        ...
        self.log.info("Start canuckcoin with -version for version information")
        ...
        self.log.info("Start canuckcoind with -fakearg to make sure it does not start")
