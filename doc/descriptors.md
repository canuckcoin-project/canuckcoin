# Support for Output Descriptors in Canuckcoin Core

Since Canuckcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Canuckcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Canuckcoin Core wallets, a convenience function `combo` is
